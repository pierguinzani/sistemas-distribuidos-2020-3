...
// import AllAdditional from '../../services/api/additional'
...
function ProductList() {
  ...
  function handleOrder() {
    ...
    setOrder(orderText)
    setOrderURL(`https://api.whatsapp.com/send?phone=5598991055667&text=Olá, gostaria de ${orderText}`)
  }
